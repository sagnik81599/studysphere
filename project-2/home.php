...
<head>
  <title>EduX - Online E-notes Good Quality, Quizzes & Certificates</title>
  <meta charset="utf-8">
...
<body>
  ...
  <nav class="main-menu d-flex navbar fixed-top navbar-expand-lg p-2 py-3 p-lg-4 py-lg-4 ">
    <div class="container-fluid">
      <div class="main-logo">
        <a href="">
          <img src="images/smartLeran AI.png" style="width: 115px;" alt="logo" class="img-fluid">
        </a>
      </div>
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body justify-content-end">
          ...
          <ul class="navbar-nav menu-list list-unstyled align-items-lg-center d-flex gap-md-3 mb-0">
            ...
            <li class="nav-item dropdown">
                 <a class="nav-link mx-2" href="#notes">notes</a>
            ...
            <li class="nav-item dropdown">
               <a href="#certificate" class="nav-link mx-2">certificates</a>
          ...
          <div class="d-none d-lg-flex align-items-center ms-5">
            <ul class="d-flex justify-content-end  list-unstyled m-0">
              <li>
                    <a class="btn btn-outline-dark mx-3 p-3" href="login.php">
  Login / Signup
</a>
              </li>
  ...
  <section id="notes" class="padding-medium">
    <div class="container">

      <div class="text-center mb-5">
        <h2 class="display-5 fw-semibold">Check our <span class="text-primary">Quality Notes</span></h2>
          ...
          <div class="card position-relative">
            ...
            <div class="card-body p-0">
              ...
              <a href="courses-details.html">
                <h5 class="py-2 m-0">The Complete Package of Digital Marketing pdf</h5>
              </a>
        ...
        <div class="item web col-md-4 col-lg-3 my-5">
          ...
          <div class="card position-relative">
            ...
            <div class="card-body p-0">
              ...
              <a href="courses-details.html">
                <h5 class="py-2 m-0">Top Marketing Strategy pdf</h5>
              </a>
...
>
        ...
        <div class="item business col-md-4 col-lg-3 my-5">
          ...
          <div class="card position-relative">
            ...
            <div class="card-body p-0">
              ...
              <a href="courses-details.html">
                <h5 class="py-2 m-0">Mega Digital Marketing Course A to Z </h5>
              </a>
        ...
        <div class="item video col-md-4 col-lg-3 my-5">
          ...
          <div class="card position-relative">
            ...
            <div class="card-body p-0">
              ...
              <a href="courses-details.html">
                <h5 class="py-2 m-0">The Complete Package of Digital Marketing </h5>
              </a>
        ...
        <div class="item web col-md-4 col-lg-3 my-5">
          ...
          <div class="card position-relative">
            ...
            <div class="card-body p-0">
              ...
              <a href="courses-details.html">
                <h5 class="py-2 m-0">Top Marketing Strategy Courses </h5>
              </a>
  ...
  <!-- ONLINE TEST SECTION -->
<section class="py-5" id="Test" style="background: linear-gradient(135deg, #ffffff, #eef2ff);">
  <div class="container">
    <div class="row align-items-center">

      <!-- LEFT CONTENT -->
      <div class="col-lg-6 col-md-12 mb-4 mb-lg-0">
        <h5 class="text-uppercase fw-bold text-secondary">Online Testing</h5>

        <h2 class="fw-bold mb-3" style="color:#0d1b2a;">
          Test Your Knowledge Anytime
        </h2>

        <p class="text-muted">
          Take interactive quizzes, improve your skills, and track your performance with our smart testing system. Practice regularly and get certified.
        </p>

        <a href="#" class="btn btn-warning px-4 py-2 mt-2">
          Start Test
        </a>
      </div>
...
<div class="col-lg-6 col-md-12 text-center">
  <img src="images/online-test.png" alt="Online Test"
       class="img-fluid"
  ...
  <section id="certificate" class="padding-medium">
    <div class="container">
      <div class="text-center">
        <h2 class="display-5 fw-semibold">view our <span class="text-primary"> latest certificates</span></h2>
        <p class="secondary-font">Get many features from us exactly what you are looking for.</p>
      </div>
      ...
      <div class="row ">
          ...
          <div class="blog-post">
            <a href="single-post.html">
              <div class="image-holder zoom-effect rounded-3">
                <img src="images/Screenshot 2026-03-27 125353.png" alt="img" class="post-image img-fluid rounded-3">
              </div>
            </a>
            <div class="mt-3">
              <a href="#">
              ...
              <a href="single-post.html">
                <h4 class="m-0">Web Development Certificate And Achievements</h4>
              </a>
            </div>
          </div>
        </div>
        <div class="col-md-4 my-5">
          <div class="blog-post">
            <a href="single-post.html">
              <div class="image-holder zoom-effect rounded-3">
                <img src="images/certificate2.png" alt="img" class="post-image img-fluid rounded-3">
              </div>
            </a>
            <div class="mt-3">
              <a href="#">
                <p class="text-black-50 m-1">Dec 5, 2024</p>
              </a>
              <a href="single-post.html">
                <h4 class="m-0">Networking Certificate And Achievements</h4>
              </a>
            </div>
          </div>
        </div>
        <div class="col-md-4 my-5">
          <div class="blog-post">
            <a href="single-post.html">
              <div class="image-holder zoom-effect rounded-3">
                <img src="images/certificate3.png" alt="img" class="post-image img-fluid rounded-3">
              </div>
            </a>
            <div class="mt-3">
              <a href="#">
                <p class="text-black-50 m-1">Dec 10, 2024</p>
              </a>
              <a href="single-post.html">
                <h4 class="m-0">Special Tips For Learning Trends During The Outbreaks</h4>
              </a>
            </div>
          </div>
        </div>
      ...
      <div class="text-center">
        <a href="view.html" class="btn btn-primary px-5 py-3 "> view all</a>
      </div>

    </div>
  </section>

  <section id="contact" style="background-image:url(images/background-img.jpg); background-repeat: no-repeat; ">
    <div class="container padding-medium">
      <div class="text-center">
